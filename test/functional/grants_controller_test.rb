...
class GrantsControllerTest < ActionController::TestCase
  ...
  test "should create grant" do
    assert_difference('Grant.count') do
      post :create, grant: { beg_year: @grant.beg_year, end_year: @grant.end_year, notes: @grant.notes, org: @grant.org }
    end
  ...
  test "should update grant" do
    put :update, id: @grant, grant: { beg_year: @grant.beg_year, end_year: @grant.end_year, notes: @grant.notes, org: @grant.org }
    assert_redirected_to grant_path(assigns(:grant))
  end
